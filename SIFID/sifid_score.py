...
parser.add_argument('--path2real',
                    default='/home/lixiang/lx/SAND-pytorvh-master/output_apd/eSPADE_Lgeo_Lsem_Lidn_2.2/x', type=str,
                    help=('Path to the real images'))
parser.add_argument('--path2fake', default='/home/lixiang/lx/SAND-pytorvh-master/result/output/apd_x_x/sketch',
